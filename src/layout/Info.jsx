...
const Info = () => {
  return (
    <div className="bg-gradient-to-b from-blue-100 to-yellow-200">
      <section className="relative z-[1] container mx-auto flex min-h-screen flex-col items-center justify-center px-5 py-5 md:px-0 md:py-10 gap-5">
        ...
        <div className="rounded-[100%/100%] border border-orange-950 p-0.5 mt-10">
          <div className="rounded-[100%/100%] border-2 border-orange-950 p-1">
            <div className="h-[calc(100vh-80px)] overflow-hidden rounded-[100%/100%] border-4 border-orange-950">
              <img
                src={pastaImg}
                alt="Macarrão"
